    ...
    <>
      <div className="mx-auto max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14">
        ...
        <div className="grid items-center gap-8 md:grid-cols-2 lg:gap-12">
          <div>
            ...
            <blockquote className="relative hidden max-w-sm md:block">
              <svg
                className="absolute start-0 top-0 size-16 -translate-x-6 -translate-y-8 transform text-gray-200 dark:text-neutral-800"
                width="16"
                height="16"
                viewBox="0 0 16 16"
                fill="none"
          ...
          <div>
            ...
            <form>
              <div className="ms-auto lg:mx-auto lg:me-0 lg:max-w-lg">
                {/* <!-- Card --> */}
                <div className="flex flex-col rounded-2xl bg-white p-4 shadow-lg dark:bg-neutral-900 sm:p-7">
                  ...
                  <div className="mt-5">
                    ...
                    <div className="flex items-center py-3 text-xs uppercase text-gray-400 before:me-6 before:flex-1 before:border-t before:border-gray-200 after:ms-6 after:flex-1 after:border-t after:border-gray-200 dark:text-neutral-500 dark:before:border-neutral-700 dark:after:border-neutral-700">
                      Or
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <div className="relative">
                          <input
                            ...
                            className="peer block w-full rounded-lg border-gray-200 p-4 text-sm placeholder:text-transparent autofill:pb-2 autofill:pt-6 focus:border-blue-500 focus:pb-2 focus:pt-6 focus:ring-blue-500 disabled:pointer-events-none disabled:opacity-50 dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-400 dark:focus:ring-neutral-600 [&:not(:placeholder-shown)]:pb-2 [&:not(:placeholder-shown)]:pt-6"
                            placeholder="John"
                          />
                          <label
                            htmlFor="hs-hero-signup-form-floating-input-first-name"
                            className="pointer-events-none absolute start-0 top-0 h-full origin-[0_0] truncate border border-transparent p-4 text-sm transition duration-100 ease-in-out peer-focus:-translate-y-1.5 peer-focus:translate-x-0.5 peer-focus:scale-90 peer-focus:text-gray-500 peer-disabled:pointer-events-none peer-disabled:opacity-50 peer-[:not(:placeholder-shown)]:-translate-y-1.5 peer-[:not(:placeholder-shown)]:translate-x-0.5 peer-[:not(:placeholder-shown)]:scale-90 peer-[:not(:placeholder-shown)]:text-gray-500 dark:text-white dark:peer-focus:text-neutral-500 dark:peer-[:not(:placeholder-shown)]:text-neutral-500"
                          >
                            First name
                          </label>
                        </div>
                      ...
                      <div className="relative col-span-full">
                        ...
                        <div
                          ...
                          className="absolute z-10 hidden w-full rounded-lg bg-gray-100 p-4 dark:bg-neutral-950"
                        >
                          <div
                    ...
                    <div className="mt-5 flex items-center">
                      <div className="flex">
                        <input
                          ...
                          name="remember-me"
                          type="checkbox"
                          className="mt-0.5 shrink-0 rounded border-gray-200 text-blue-600 focus:ring-blue-500 dark:border-neutral-700 dark:bg-neutral-900 dark:checked:border-blue-500 dark:checked:bg-blue-500 dark:focus:ring-offset-gray-800"
                        />
                      </div>
                      <div className="ms-3">
                        <label
        ...
        <div className="flex flex-wrap gap-x-6 sm:gap-x-12 lg:gap-x-24">
          <svg
            className="h-auto w-16 py-3 text-gray-500 dark:text-neutral-500 md:w-20 lg:w-24 lg:py-5"
